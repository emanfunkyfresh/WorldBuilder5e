...
public class Door {
	...
	public Door(int roll, int i, String string) {
		...
		if (roll >= 3 && roll <= 8) {
			beyondTheDoor.add(new Passage(dbag.roll(1, 20),dbag.roll(1, 20),"Forward"));
		}
		
		else if (roll <= 2) {
			beyondTheDoor.add(new Passage(dbag.roll(1, 20),dbag.roll(1, 20),"Left"));
			beyondTheDoor.add(new Passage(dbag.roll(1, 20),dbag.roll(1, 20),"Right"));
		}
		
		else if (roll >= 9 && roll <= 18) {
			beyondTheDoor.add(new Chamber(dbag.roll(1, 20),dbag.roll(1, 20),"Forward"));
		}
		
		else if(roll == 19) {
			beyondTheDoor.add(new Stairs(dbag.roll(1, 20),dbag.roll(1, 20),"Forward"));
		}
